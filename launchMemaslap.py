...
def launchMemaslap(settings):
  ...
  imageIdCellCycle = "ami-7e854111"
  keyName = settings.getAwsKeyName()
  securityGroup = settings.getAwsSecurityGroup()
  privateIp = "172.31.21.1"
  ec2.create_instances(ImageId=imageIdCellCycle, MinCount=1, MaxCount=1, InstanceType='t2.micro', KeyName=keyName, SecurityGroups=[securityGroup],  PrivateIpAddress=privateIp)
