...
def launchMemaslap(settings):
  ...
  userData = 'echo "alias memaslap-test="memaslap -s 172.31.20.1:5555,172.31.20.2:5555,172.31.20.3:5555,172.31.20.4:5555,172.31.20.5:5555"" >> ~/.bashrc\necho "questa è una pratica guida"'
