...
import time
time.sleep(1)
print "sul task principale ho ricevuto con chiave 1 su slave:" + str(getRequest(getSlavePipeList[0], 1))
print "sul task principale ho ricevuto con chiave 1 su master: " + str(getRequest(getMasterPipeList[0], 1))
