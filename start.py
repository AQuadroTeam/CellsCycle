...
# Create new threads
thread3 = ReadingThread([3,5557], [1,5555], [2,5555], [], [0, 127], [0, 127], logger)
thread2 = ReadingThread([2,5555], [3,5556], [1,5556], [], [0, 127], [0, 127], logger)
thread1 = ReadingThread([1,5556], [2,5557], [3,5557], [], [0, 127], [0, 127], logger)

thread6 = WritingThread([3,5557], [1,5555], [2,5555], [], [0, 127], [0, 127], logger)
thread5 = WritingThread([2,5555], [3,5556], [1,5556], [], [0, 127], [0, 127], logger)
thread4 = WritingThread([1,5556], [2,5557], [3,5557], [], [0, 127], [0, 127], logger)
