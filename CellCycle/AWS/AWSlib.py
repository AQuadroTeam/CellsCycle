...
def startInstanceAWS(settings, logger):
    ...
    userData = "#!/bin/bash\ngit -C /home/ubuntu/git/CellsCycle/ checkout "+branch+"\ngit -C /home/ubuntu/git/CellsCycle/ pull origin "+branch+"\n/usr/bin/python /home/ubuntu/git/CellsCycle/startOnBoot.py\nADDRESSOFFATHER=prova"
